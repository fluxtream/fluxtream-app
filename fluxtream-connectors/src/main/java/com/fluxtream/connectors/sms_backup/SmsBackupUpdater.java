...
public class SmsBackupUpdater extends SettingsAwareAbstractUpdater {
	...
	void retrieveCallLogSinceDate(UpdateInfo updateInfo,
		...
		try {
            ...
            notificationsService.addNamedNotification(updateInfo.getGuestId(), Notification.Type.ERROR, connector().getName() + ".callLogFolderError", "The call log folder configured for SMS Backup, \"" + callLogFolderName + "\", does not exist.");
