function grapher2(){
  ...
  if (!isHostedMode()) {
    try {
      ...
      unflattenKeylistIntoAnswers([$intern_49, $intern_53], $intern_64);
      unflattenKeylistIntoAnswers([$intern_44, $intern_53], $intern_64 + $intern_65);
      unflattenKeylistIntoAnswers([$intern_49, $intern_53], $intern_64 + $intern_65);
      unflattenKeylistIntoAnswers([$intern_44, $intern_59], $intern_66);
      unflattenKeylistIntoAnswers([$intern_49, $intern_59], $intern_66);
      unflattenKeylistIntoAnswers([$intern_44, $intern_59], $intern_66 + $intern_65);
      unflattenKeylistIntoAnswers([$intern_49, $intern_59], $intern_66 + $intern_65);
