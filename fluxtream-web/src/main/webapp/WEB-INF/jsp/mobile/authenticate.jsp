            ...
            <div class="cover-container">
                <div class="innner cover">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-md-offset-4">
                                <p>You are not logged in. Please enter your credentials to continue</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4 col-md-offset-4 sireg-form-wrapper">
                                <form role="form" class="form-horizontal" action="<%=signInURL%>" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control" type="password" autocorrect="off" autocapitalize="off" id="f_password" name="f_password" placeholder="••••••••">
                                        </div>
                                    </div>
                                    <div class="form-group">
