define(["core/Application", "core/FlxState", "applications/calendar/tabs/timeline/BodyTrack"], function(Application, FlxState, BTCore) {
    ...
    function updateLoadViewDropdown(){
        App.loadMustacheTemplate("applications/calendar/tabs/timeline/timelineTemplates.html","loadViewsDropdown",function(template){
            ...
            $("#_timeline_load_view_submenu").click(function(event){
    ...
    function updateSaveViewDropdown(){
        App.loadMustacheTemplate("applications/calendar/tabs/timeline/timelineTemplates.html","saveViewDropdown",function(template){
            ...
            $("#_timeline_save_view_dropdown-submenu").click(function (event){
                event.stopImmediatePropagation();
            });
    ...
    function toggleAddChannelsPane() {
        ...
        if (area.css("display") === "none") {
            $("#_timeline_add_channels_btn").addClass("active");
            area.show();
            TOOLS.resizeElementHeight($("#_timeline_addChannelsArea #_timeline_sources_list"));
        }
        else {
            $("#_timeline_add_channels_btn").removeClass("active");
            area.hide();
        }
    ...
    function toggleDetailsPane() {
        ...
        if (area.css("display") === "none") {
            $("#_timeline_show_details_btn").addClass("active");
            area.show();
        }
        else {
            $("#_timeline_show_details_btn").removeClass("active");
            area.hide();
        }
