define(["core/Application", "core/FlxState", "applications/calendar/tabs/timeline/BodyTrack"], function(Application, FlxState, BodyTrack) {
...
//			plot.addDataPointListener(commentDataPointListener(channelElementId));
    ...
    return Timeline;
});define(["core/Application", "core/FlxState", "applications/timeline/BodyTrack"], function(Application, FlxState, BodyTrack) {
