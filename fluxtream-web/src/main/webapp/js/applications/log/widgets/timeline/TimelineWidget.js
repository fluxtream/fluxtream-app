define(
		...
		function() {
			...
			function renderTimelineWidget(data) {
				...
				dataSource = function(level, offset, success_callback,
						failure_callback) {
					var urlPrefix = "/bodytrack/tiles/3/" + deviceName + "."
							+ channelName + "/";
				...
				var plot = new DataSeriesPlot(dataSource, dateAxis, yAxis, viewModel.v2.y_axes[0].style);
				var plotContainer = new PlotContainer("_timeline_pc", [ plot ]);
			}
