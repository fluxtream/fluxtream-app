define(["applications/log/widgets/diary/Status",
	...
	function render(digest, timeUnit) {
		this.getTemplate("text!applications/log/widgets/diary/" + timeUnit.toLowerCase() + "Diary.html", "diary-" + timeUnit, function() {
	...
	var diaryWidget = new Widget("diary", "Candide Kemmler", "icon-pencil");
