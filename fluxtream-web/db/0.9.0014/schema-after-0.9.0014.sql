...
) ENGINE=InnoDB AUTO_INCREMENT=11895 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=212646 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Connector` (
  ...
  `text` longtext,
  `supportsRenewTokens` char(1) NOT NULL DEFAULT 'N',
  `renewTokensUrlTemplate` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `Facet_FitbitActivity` (
  ...
  KEY `timeUpdated_index` (`timeUpdated`),
  KEY `apiKeyId` (`apiKeyId`)
) ENGINE=InnoDB AUTO_INCREMENT=35542 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Facet_FitbitSleep` (
  ...
  KEY `timeUpdated_index` (`timeUpdated`),
  KEY `apiKeyId` (`apiKeyId`)
) ENGINE=InnoDB AUTO_INCREMENT=6625 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Facet_LastFmRecentTrack` (
  ...
  KEY `timeUpdated_index` (`timeUpdated`),
  KEY `apiKeyId` (`apiKeyId`)
) ENGINE=InnoDB AUTO_INCREMENT=261694 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=513964 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Facet_PicasaPhotoEntry` (
  ...
  KEY `timeUpdated_index` (`timeUpdated`),
  KEY `apiKeyId` (`apiKeyId`)
) ENGINE=InnoDB AUTO_INCREMENT=7959 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Facet_Tweet` (
  ...
  KEY `timeUpdated_index` (`timeUpdated`),
  KEY `apiKeyId` (`apiKeyId`)
) ENGINE=InnoDB AUTO_INCREMENT=9411 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Facet_ZeoSleepStats` (
  ...
  KEY `timeUpdated_index` (`timeUpdated`),
  KEY `apiKeyId` (`apiKeyId`)
) ENGINE=InnoDB AUTO_INCREMENT=9930 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Guest` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `connectorConfigStateKey` varchar(255) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=150547 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=119802 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2013-05-20 19:42:37
