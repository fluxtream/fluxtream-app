...
CREATE TABLE `Facet_SleepAsAndroidSleep` (
  ...
  `sleepComment` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `sleepTags` longtext,
...
INSERT INTO Gestalt (channelMappingsFixupWasExecuted) values ('Y');

-- Dump completed on 2015-06-24  9:44:22
