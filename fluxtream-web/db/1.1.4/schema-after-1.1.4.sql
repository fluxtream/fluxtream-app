...
) ENGINE=InnoDB AUTO_INCREMENT=7056 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=118648160 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ApiNotifications` (
  ...
  KEY `guestId` (`guestId`),
  KEY `api` (`api`)
) ENGINE=InnoDB AUTO_INCREMENT=14923 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=99097069 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ChannelMapping` (
  ...
  `objectTypes` int(11) DEFAULT NULL,
  `timeType` int(11) DEFAULT NULL,
  `creationType` tinyint(4) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `channelName` (`channelName`(191)),
  KEY `deviceName` (`deviceName`(191)),
  KEY `guestId` (`guestId`),
  KEY `apiKey` (`apiKeyId`)
) ENGINE=InnoDB AUTO_INCREMENT=513604 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ChannelStyle` (
  ...
  KEY `guestId` (`guestId`)
) ENGINE=InnoDB AUTO_INCREMENT=29445 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Connector` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=4709 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=115239248 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `Facet_BedditSleep`
--

DROP TABLE IF EXISTS `Facet_BedditSleep`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
CREATE TABLE `Facet_BodymediaBurn` (
  ...
  KEY `apiKeyId` (`apiKeyId`),
  KEY `date` (`date`)
) ENGINE=InnoDB AUTO_INCREMENT=59899 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Facet_BodymediaSleep` (
  ...
  KEY `apiKeyId` (`apiKeyId`),
  KEY `date` (`date`)
) ENGINE=InnoDB AUTO_INCREMENT=45121 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Facet_BodymediaSteps` (
  ...
  KEY `timeUpdated_index` (`timeUpdated`),
  KEY `apiKeyId` (`apiKeyId`)
) ENGINE=InnoDB AUTO_INCREMENT=41877 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Facet_CallLog` (
  ...
  KEY `timeUpdated_index` (`timeUpdated`),
  KEY `emailId` (`emailId`)
) ENGINE=InnoDB AUTO_INCREMENT=150056 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Facet_EvernoteNote` (
  ...
  KEY `apiKey` (`apiKeyId`),
  KEY `timeUpdated_index` (`timeUpdated`)
) ENGINE=InnoDB AUTO_INCREMENT=618496 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Facet_EvernoteResource` (
  ...
  KEY `apiKey` (`apiKeyId`),
  KEY `timeUpdated_index` (`timeUpdated`)
) ENGINE=InnoDB AUTO_INCREMENT=1390160 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Facet_EvernoteTag` (
  ...
  KEY `apiKey` (`apiKeyId`),
  KEY `timeUpdated_index` (`timeUpdated`)
) ENGINE=InnoDB AUTO_INCREMENT=55643 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Facet_FitbitActivity` (
  ...
  KEY `apiKeyId` (`apiKeyId`),
  KEY `date` (`date`)
) ENGINE=InnoDB AUTO_INCREMENT=1736590 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Facet_FitbitFoodLogEntry` (
  ...
  KEY `timeUpdated_index` (`timeUpdated`),
  KEY `logId` (`logId`)
) ENGINE=InnoDB AUTO_INCREMENT=3073584 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Facet_FitbitFoodLogSummary` (
  ...
  KEY `apiKey` (`apiKeyId`),
  KEY `timeUpdated_index` (`timeUpdated`)
) ENGINE=InnoDB AUTO_INCREMENT=1434092 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Facet_FitbitLoggedActivity` (
  ...
  KEY `date` (`date`),
  KEY `logId` (`logId`)
) ENGINE=InnoDB AUTO_INCREMENT=86540 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Facet_FitbitSleep` (
  ...
  KEY `date` (`date`),
  KEY `logId` (`logId`)
) ENGINE=InnoDB AUTO_INCREMENT=13349223 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Facet_FitbitWeight` (
  ...
  KEY `date` (`date`),
  KEY `logId` (`logId`)
) ENGINE=InnoDB AUTO_INCREMENT=991807 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Facet_FlickrPhoto` (
  ...
  KEY `apiKeyId` (`apiKeyId`),
  KEY `date` (`date`(191))
) ENGINE=InnoDB AUTO_INCREMENT=14292261 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `Facet_FluxtreamCaptureObservation`
--

DROP TABLE IF EXISTS `Facet_FluxtreamCaptureObservation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
CREATE TABLE `Facet_FluxtreamCapturePhoto` (
  ...
  KEY `hash_index` (`hash`),
  KEY `apiKeyId` (`apiKeyId`)
) ENGINE=MyISAM AUTO_INCREMENT=27265 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `Facet_FluxtreamCaptureTopic`
--

DROP TABLE IF EXISTS `Facet_FluxtreamCaptureTopic`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
CREATE TABLE `Facet_GoogleCalendarEvent` (
  ...
  KEY `apiKey` (`apiKeyId`),
  KEY `timeUpdated_index` (`timeUpdated`)
) ENGINE=InnoDB AUTO_INCREMENT=6759592 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Facet_JawboneUpMeal` (
  ...
  KEY `apiKey` (`apiKeyId`),
  KEY `timeUpdated_index` (`timeUpdated`)
) ENGINE=InnoDB AUTO_INCREMENT=37928 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Facet_JawboneUpMoves` (
  ...
  KEY `apiKey` (`apiKeyId`),
  KEY `timeUpdated_index` (`timeUpdated`)
) ENGINE=InnoDB AUTO_INCREMENT=36425 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=67529 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Facet_JawboneUpSleep` (
  ...
  KEY `apiKey` (`apiKeyId`),
  KEY `timeUpdated_index` (`timeUpdated`)
) ENGINE=InnoDB AUTO_INCREMENT=27200 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Facet_LastFmRecentTrack` (
  ...
  KEY `timeUpdated_index` (`timeUpdated`),
  KEY `apiKeyId` (`apiKeyId`)
) ENGINE=InnoDB AUTO_INCREMENT=10834104 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=307320588 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `Facet_MisfitActivitySession`
--

DROP TABLE IF EXISTS `Facet_MisfitActivitySession`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `Facet_MisfitActivitySummary`
--

DROP TABLE IF EXISTS `Facet_MisfitActivitySummary`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `Facet_MisfitSleep`
--

DROP TABLE IF EXISTS `Facet_MisfitSleep`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
CREATE TABLE `Facet_MovesMove` (
  ...
  KEY `timeUpdated_index` (`timeUpdated`),
  KEY `date` (`date`)
) ENGINE=InnoDB AUTO_INCREMENT=1576435 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Facet_MovesPlace` (
  ...
  KEY `timeUpdated_index` (`timeUpdated`),
  KEY `date` (`date`(191))
) ENGINE=InnoDB AUTO_INCREMENT=2003362 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Facet_MymeeObservation` (
  ...
  KEY `timeUpdated_index` (`timeUpdated`),
  KEY `apiKeyId` (`apiKeyId`)
) ENGINE=InnoDB AUTO_INCREMENT=118694 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Facet_QuantifiedMindTest` (
  ...
  KEY `timeUpdated_index` (`timeUpdated`),
  KEY `apiKeyId` (`apiKeyId`)
) ENGINE=InnoDB AUTO_INCREMENT=13023 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Facet_RunKeeperFitnessActivity` (
  ...
  KEY `timeUpdated_index` (`timeUpdated`),
  KEY `apiKeyId` (`apiKeyId`)
) ENGINE=InnoDB AUTO_INCREMENT=110794 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `Facet_SleepAsAndroidSleep`
--

DROP TABLE IF EXISTS `Facet_SleepAsAndroidSleep`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
CREATE TABLE `Facet_SmsEntry` (
  ...
  KEY `timeUpdated_index` (`timeUpdated`),
  KEY `emailId` (`emailId`)
) ENGINE=InnoDB AUTO_INCREMENT=737900 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Facet_Tweet` (
  ...
  KEY `timeUpdated_index` (`timeUpdated`),
  KEY `apiKeyId` (`apiKeyId`)
) ENGINE=InnoDB AUTO_INCREMENT=993688 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Facet_TwitterDirectMessage` (
  ...
  KEY `timeUpdated_index` (`timeUpdated`),
  KEY `apiKeyId` (`apiKeyId`)
) ENGINE=InnoDB AUTO_INCREMENT=175822 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Facet_TwitterMention` (
  ...
  KEY `timeUpdated_index` (`timeUpdated`),
  KEY `apiKeyId` (`apiKeyId`)
) ENGINE=InnoDB AUTO_INCREMENT=452731 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Facet_VisitedCity` (
  ...
  KEY `date` (`date`)
) ENGINE=MyISAM AUTO_INCREMENT=2701080 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Facet_WithingsActivity` (
  ...
  KEY `apiKey` (`apiKeyId`),
  KEY `date` (`date`(250))
) ENGINE=MyISAM AUTO_INCREMENT=31349 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Facet_WithingsBodyScaleMeasure` (
  ...
  KEY `timeUpdated_index` (`timeUpdated`),
  KEY `apiKeyId` (`apiKeyId`)
) ENGINE=InnoDB AUTO_INCREMENT=137119 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Facet_WithingsHeartPulseMeasure` (
  ...
  KEY `apiKey` (`apiKeyId`),
  KEY `timeUpdated_index` (`timeUpdated`)
) ENGINE=InnoDB AUTO_INCREMENT=36201 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `FitbitUserProfile` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `aboutMe` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
) ENGINE=InnoDB AUTO_INCREMENT=19119 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `Gestalt`
--

DROP TABLE IF EXISTS `Gestalt`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `Gestalt` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `channelMappingsFixupWasExecuted` char(1) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Notifications` (
  ...
  PRIMARY KEY (`id`),
  KEY `guestId_index` (`guestId`)
) ENGINE=InnoDB AUTO_INCREMENT=10418 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `SharedChannels` (
  ...
  CONSTRAINT `FKFD3DCB7568CEBFC9` FOREIGN KEY (`buddy_id`) REFERENCES `TrustedBuddies` (`id`)
...
CREATE TABLE `SharedConnectors` (
  ...
  CONSTRAINT `FK_BUDDY` FOREIGN KEY (`buddy_id`) REFERENCES `TrustedBuddies` (`id`)
...
CREATE TABLE `Tags` (
  ...
  KEY `name` (`name`),
  KEY `guestId_index` (`guestId`)
) ENGINE=InnoDB AUTO_INCREMENT=143811 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `TrustedBuddies`
--

DROP TABLE IF EXISTS `TrustedBuddies`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `TrustedBuddies` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `guestId` bigint(20) NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=3529787 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=429581 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2015-02-27 13:37:59
