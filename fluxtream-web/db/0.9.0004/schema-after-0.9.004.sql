...
CREATE TABLE `ApiUpdates` (
  ...
  KEY `api` (`api`),
  KEY `success` (`success`)
) ENGINE=MyISAM AUTO_INCREMENT=38436 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Facet_FitbitActivity` (
  ...
  KEY `guestId_index` (`guestId`),
  KEY `timeUpdated_index` (`timeUpdated`)
) ENGINE=MyISAM AUTO_INCREMENT=9399 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Facet_FitbitSleep` (
  ...
  KEY `guestId_index` (`guestId`),
  KEY `timeUpdated_index` (`timeUpdated`)
) ENGINE=MyISAM AUTO_INCREMENT=9217 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Facet_GoogleLatitudeLocation` (
  ...
  KEY `timeUpdated_index` (`timeUpdated`)
) ENGINE=MyISAM AUTO_INCREMENT=280123 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Facet_MymeeObservation` (
  ...
  KEY `guestId_index` (`guestId`),
  KEY `timeUpdated_index` (`timeUpdated`)
) ENGINE=InnoDB AUTO_INCREMENT=7275 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Facet_ZeoSleepStats` (
  ...
  KEY `guestId_index` (`guestId`),
  KEY `timeUpdated_index` (`timeUpdated`)
) ENGINE=MyISAM AUTO_INCREMENT=3110 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ScheduledUpdate` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=33372 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=42803 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2012-11-07 16:34:53
