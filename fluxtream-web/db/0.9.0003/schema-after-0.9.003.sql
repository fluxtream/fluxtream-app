...
CREATE TABLE `ApiUpdates` (
  ...
  KEY `api` (`api`),
  KEY `success` (`success`)
) ENGINE=MyISAM AUTO_INCREMENT=37349 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Facet_FitbitActivity` (
  ...
  KEY `guestId_index` (`guestId`),
  KEY `timeUpdated_index` (`timeUpdated`)
) ENGINE=MyISAM AUTO_INCREMENT=7936 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `Facet_FitbitBodyMeasurement`
--

DROP TABLE IF EXISTS `Facet_FitbitBodyMeasurement`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `Facet_FitbitBodyMeasurement` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `api` int(11) NOT NULL,
  `comment` longtext,
  `end` bigint(20) NOT NULL,
...
CREATE TABLE `Facet_FitbitSleep` (
  ...
  KEY `guestId_index` (`guestId`),
  KEY `timeUpdated_index` (`timeUpdated`)
) ENGINE=MyISAM AUTO_INCREMENT=7818 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Facet_GoogleLatitudeLocation` (
  ...
  KEY `timeUpdated_index` (`timeUpdated`)
) ENGINE=MyISAM AUTO_INCREMENT=252311 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Facet_PicasaPhotoEntry` (
  ...
  KEY `guestId_index` (`guestId`),
  KEY `timeUpdated_index` (`timeUpdated`)
) ENGINE=MyISAM AUTO_INCREMENT=12569 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Facet_ZeoSleepStats` (
  ...
  KEY `guestId_index` (`guestId`),
  KEY `timeUpdated_index` (`timeUpdated`)
) ENGINE=MyISAM AUTO_INCREMENT=3081 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ScheduledUpdate` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=32494 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=42315 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2012-11-01 10:20:42
