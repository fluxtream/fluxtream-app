...
<head>
    ...
    <link href="${release}/css/style-responsive-default.css" rel="stylesheet">
...
<div id="login" style="display:none;">
    <div class="cont cf">
        ...
        <form method="post" action="signIn" id="loginForm">
            ...
            <input type="hidden" name="isDeveloperLogin" value="true"/>
            <%--<input type="hidden" name="login[_csrf_token]" value="965e5cf220b402ba98a8344266bb804d" id="login__csrf_token" />--%>
        </form>
