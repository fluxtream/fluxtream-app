...
public class PhotoServiceImpl implements PhotoService {
    ...
    @Override
    public Map<String, TimeInterval> getPhotoChannelTimeRanges(final long guestId, final TrustingBuddy trustingBuddy) {
        ...
        for (ApiKey apiKey : userKeys) {
            ...
            if (connector != null && connector.getName() != null &&
                (trustingBuddy == null || trustingBuddy.hasAccessToConnector(connector.getName())) && connector.hasImageObjectType()) {
