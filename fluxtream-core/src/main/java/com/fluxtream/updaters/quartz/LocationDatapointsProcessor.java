...
public class LocationDatapointsProcessor implements InitializingBean {
    ...
    public List<LocationFacet> getUnprocessedLocationDatapoints() {
        ...
        final List<LocationFacet> locationFacets = jpaDaoService.executeQueryWithLimit("SELECT facet from " + entityName + " facet WHERE facet.processed = false", 20000, LocationFacet.class);
