...
//	}
	...
	private void initializeConnectorList() {
		...
		em.persist(new ConnectorInfo("Toodledo", "/images/connectors/connector-toodledo.png",
				res.getString("toodledo"),
				"ajax:/toodledo/enterCredentials", Connector.getConnector("toodledo"), 1,
				true));
		em.persist(new ConnectorInfo("Zeo", "/images/connectors/connector-focus-zeo.jpg",
				res.getString("zeo"),
				"/zeo/subscribe", Connector.getConnector("zeo"), 1,
				true));
		em.persist(new ConnectorInfo("Withings B Scale",
				"/images/connectors/connector-focus-whithings-balance.jpg", res.getString("withings"),
				"ajax:/withings/enterCredentials", Connector
						.getConnector("WITHINGS"), 2, true));
		em.persist(new ConnectorInfo("Google Calendar",
				"/images/connectors/connector-google-calendar.jpg", res.getString("google_calendar"),
		...
		em.persist(new ConnectorInfo("Fitbit",
				"/images/connectors/connector-focus-fitbit.jpg", res.getString("fitbit"),
				"/fitbit/token", Connector.getConnector("fitbit"), 5, true));
		// em.persist(new ConnectorInfo("Freshbooks",
		// "/images/connectors/connector-freshbooks.jpeg", res.getString("freshbooks"), "/freshbooks/token",
		// Connector.getConnector("FRESHBOOKS"), 6));
		// em.persist(new ConnectorInfo("Google Contacts",
		// "/images/connectors/connector-google-contact.jpeg", res.getString("google_contacts"),
