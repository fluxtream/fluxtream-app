...
function ephemerisLabel(digestInfo) {
	...
	return "<span class=\"ephemeris\"><div class=\"iconClockSun\"></div>" + sunriseH + ":" + sunriseM + " am"+
		"&nbsp;<div class=\"iconClockMoon\"></div>" + sunsetH + ":" + sunsetM + " pm</span>";
}

function temperaturesLabel(digestInfo) {
	if (digestInfo.maxTempC!=-10000) {
		if (digestInfo.settings.temperatureUnit=="CELSIUS") {
			return ephemerisLabel(digestInfo) + "<div class=\"iconTemperature\"></div>"
